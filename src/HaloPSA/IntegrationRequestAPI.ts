...
export class IntegrationRequestAPI extends HaloPSA {
   ...
   */
  postIntegrationRequest(integrationRequest: Array<IntegrationRequest>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/IntegrationRequest',
   ...
   */
  getIntegrationRequestById(id: number, includedetails: boolean): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {number} id
   */
  deleteIntegrationRequestById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/IntegrationRequest/${id}`,
    })
