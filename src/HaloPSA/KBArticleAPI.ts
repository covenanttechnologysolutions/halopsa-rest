...
export class KBArticleAPI extends HaloPSA {
   ...
   */
  postKBArticle({ kBEntry }: { kBEntry: Array<KBEntry> }): Promise<any> {
    return this.request({
      method: 'post',
      path: '/KBArticle',
      data: kBEntry,
   ...
   * @param {number} id
   */
  deleteKBArticleById({ id }: { id: number }): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/KBArticle/${id}`,
    })
   ...
   */
  postKBArticleVote({ kBEntry }: { kBEntry: Array<KBEntry> }): Promise<any> {
    return this.request({
      method: 'post',
      path: '/KBArticle/vote',
      data: kBEntry,
