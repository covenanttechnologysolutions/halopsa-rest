...
export class ExternalLinkAPI extends HaloPSA {
   ...
   */
  postExternalLink(externalLink_List: Array<ExternalLink_List>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/ExternalLink',
   ...
   */
  getExternalLinkById(id: number, includedetails: boolean): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {number} id
   */
  deleteExternalLinkById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/ExternalLink/${id}`,
    })
   ...
   */
  postExternalLinkGenerate(generateExternalLink: GenerateExternalLink): Promise<any> {
    return this.request({
      method: 'post',
