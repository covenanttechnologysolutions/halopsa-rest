 ...
 * @public
 */
export class OpportunitiesAPI extends HaloPSA {
   ...
   */
  postOpportunities({ faults }: { faults: Array<Faults> }): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Opportunities',
      data: faults,
   ...
   * @param {string} [reason] 
   */
  deleteOpportunitiesById({ id, reason }: { id: number; reason?: string }): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Opportunities/${id}`,
      params: {
   ...
   */
  postOpportunitiesView({ faults }: { faults: Array<Faults> }): Promise<any> {
    return this.request({
      method: 'post',
