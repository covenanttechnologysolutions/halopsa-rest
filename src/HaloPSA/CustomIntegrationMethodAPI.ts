 ...
 * @public
 */
export class CustomIntegrationMethodAPI extends BaseAPI {
  /**
  ...
  postCustomIntegrationMethod({
    outboundIntegrationMethodList,
  }: {
    outboundIntegrationMethodList: Array<OutboundIntegrationMethod>
  }): Promise<unknown> {
    return this.request({
      method: 'post',
      data: outboundIntegrationMethodList,
      path: '/CustomIntegrationMethod',
    })
  }
   ...
   * @param {number} id
   */
  deleteCustomIntegrationMethodById({ id }: { id: number }): Promise<unknown> {
    return this.request({ method: 'delete', path: `/CustomIntegrationMethod/${id}` })
  }
}
