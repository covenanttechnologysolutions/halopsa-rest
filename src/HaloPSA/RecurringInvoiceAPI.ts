...
export class RecurringInvoiceAPI extends HaloPSA {
   ...
   */
  postRecurringInvoice(invoiceHeader: Array<InvoiceHeader>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/RecurringInvoice',
      data: invoiceHeader,
   ...
   */
  getRecurringInvoiceById(id: number, includedetails: boolean): Promise<any> {
    return this.request({
      method: 'get',
   ...
   */
  deleteRecurringInvoiceById(id: number, bypass_accounts_sync: boolean): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/RecurringInvoice/${id}`,
      params: {
   ...
   */
  postRecurringInvoiceUpdatelines(invoiceDetail: Array<InvoiceDetail>): Promise<any> {
    return this.request({
      method: 'post',
   ...
   */
  postRecurringInvoiceProcess(listNumber: number): Promise<any> {
    return this.request({
      method: 'post',
   ...
   */
  postRecurringInvoiceLines(invoiceDetail: Array<InvoiceDetail>): Promise<any> {
    return this.request({
      method: 'post',
