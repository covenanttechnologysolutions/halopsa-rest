...
export class ConfigCommitAPI extends HaloPSA {
   ...
   */
  postConfigCommit(configCommit: Array<ConfigCommit>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/ConfigCommit',
      data: configCommit,
   ...
   * @param {number} instance_id 
   */
  getConfigCommitById(id: number, includedetails: boolean, instance_id: number): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {number} id
   */
  deleteConfigCommitById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/ConfigCommit/${id}`,
    })
