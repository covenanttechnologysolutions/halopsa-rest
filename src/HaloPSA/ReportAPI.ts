...
export class ReportAPI extends HaloPSA {
   ...
   */
  postReport(analyzerProfile: Array<AnalyzerProfile>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Report',
   ...
   * @param {number} id
   */
  deleteReportById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Report/${id}`,
    })
   ...
   */
  postReportPrint(analyzerProfile: Array<AnalyzerProfile>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Report/print',
      data: analyzerProfile,
   ...
   */
  postReportCreatepdf(analyzerProfile: AnalyzerProfile): Promise<any> {
    return this.request({
      method: 'post',
   ...
   */
  postReportBookmark(analyzerProfile: AnalyzerProfile): Promise<any> {
    return this.request({
      method: 'post',
