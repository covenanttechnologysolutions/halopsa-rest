...
export class TicketsAPI extends HaloPSA {
   ...
   */
  postTickets(faults: Array<Faults>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Tickets',
      data: faults,
   ...
   * @param {string} reason
   */
  deleteTicketsById(id: number, reason: string): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Tickets/${id}`,
      params: {
   ...
   */
  postTicketsObject(faults: Faults): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Tickets/Object',
      data: faults,
   ...
   */
  postTicketsVote(faults: Array<Faults>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Tickets/vote',
      data: faults,
   ...
   */
  postTicketsView(faults: Array<Faults>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Tickets/View',
      data: faults,
   ...
   */
  postTicketsProcesschildren(faults: Array<Faults>): Promise<any> {
    return this.request({
      method: 'post',
