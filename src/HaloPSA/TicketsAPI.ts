...
export class TicketsAPI extends BaseAPI {
  ...
  postTickets({ faultsList }: { faultsList: Array<Faults> }): Promise<Faults> {
    return this.request({ method: 'post', data: faultsList, path: '/Tickets' })
  }
   ...
   * @param {string} [reason]
   */
  deleteTicketsById({ id, reason }: { id: number; reason?: string }): Promise<unknown> {
    return this.request({ method: 'delete', path: `/Tickets/${id}`, params: { reason } })
  }

  getTicketsZapier(): Promise<unknown> {
    return this.request({ method: 'get', path: '/Tickets/zapier' })
  }

  getTicketsSalesmailbox(): Promise<unknown> {
    return this.request({ method: 'get', path: '/Tickets/salesmailbox' })
  }

  postTicketsObject({ faults }: { faults: Faults }): Promise<unknown> {
    return this.request({ method: 'post', data: faults, path: '/Tickets/Object' })
  }

  postTicketsVote({ faultsList }: { faultsList: Array<Faults> }): Promise<unknown> {
    return this.request({ method: 'post', data: faultsList, path: '/Tickets/vote' })
  }

  postTicketsView({ faultsList }: { faultsList: Array<Faults> }): Promise<unknown> {
    return this.request({ method: 'post', data: faultsList, path: '/Tickets/View' })
  }

  postTicketsProcesschildren({ faultsList }: { faultsList: Array<Faults> }): Promise<unknown> {
    return this.request({ method: 'post', data: faultsList, path: '/Tickets/processchildren' })
  }

  postTicketsSetBillableProject(): Promise<unknown> {
    return this.request({ method: 'post', path: '/Tickets/SetBillableProject' })
  }
}
