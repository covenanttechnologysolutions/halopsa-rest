...
export class ActionsAPI extends HaloPSA {
   ...
   */
  postActions(actions: Array<Actions>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Actions',
      data: actions,
   ...
   * @param {number} id
   */
  deleteActionsById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Actions/${id}`,
    })
   ...
   */
  postActionsReaction(actionReaction: ActionReaction): Promise<any> {
    return this.request({
      method: 'post',
   ...
   */
  postActionsReview(actions: Array<Actions>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Actions/Review',
      data: actions,
