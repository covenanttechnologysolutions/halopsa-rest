...
/**
 * @module DashboardLinksRepositoryAPI
 */

/**
 * DashboardLinksRepository module
 * @public
 */
export class DashboardLinksRepositoryAPI extends BaseAPI {
  /**
   ...
   * @param {number} [userid]
   */
  getDashboardLinksRepositoryById({
    id,
    getreporttoken,
    includedetails,
    showall,
