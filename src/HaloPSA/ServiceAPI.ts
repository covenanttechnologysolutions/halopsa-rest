...
export class ServiceAPI extends HaloPSA {
   ...
   */
  postService(servSite: Array<ServSite>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Service',
      data: servSite,
   ...
   * @param {number} user_id 
   */
  getServiceById(id: number, includedetails: boolean, user_id: number): Promise<any> {
    return this.request({
      method: 'get',
      path: `/Service/${id}`,
      params: {
   ...
   * @param {number} id
   */
  deleteServiceById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Service/${id}`,
    })
   ...
   */
  postServiceUnsubscribe(unsubscribeService: Array<UnsubscribeService>): Promise<any> {
    return this.request({
      method: 'post',
