...
export class ClientContractAPI extends HaloPSA {
   ...
   */
  postClientContract(contractHeader: Array<ContractHeader>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/ClientContract',
      data: contractHeader,
   ...
   * @param {number} id
   */
  deleteClientContractById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/ClientContract/${id}`,
    })
   ...
   */
  postClientContractNextRef(contractHeader: Array<ContractHeader>): Promise<any> {
    return this.request({
      method: 'post',
