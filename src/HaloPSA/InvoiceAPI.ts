...
export class InvoiceAPI extends HaloPSA {
   ...
   */
  postInvoice(invoiceHeader: Array<InvoiceHeader>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Invoice',
      data: invoiceHeader,
   ...
   */
  getInvoiceById(id: number, includedetails: boolean): Promise<any> {
    return this.request({
      method: 'get',
      path: `/Invoice/${id}`,
      params: {
   ...
   */
  deleteInvoiceById(id: number, bypass_accounts_sync: boolean): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Invoice/${id}`,
      params: {
   ...
   */
  postInvoiceUpdatelines(invoiceDetail: Array<InvoiceDetail>): Promise<any> {
    return this.request({
      method: 'post',
   ...
   * @param {number} id
   */
  postInvoicePDFById(id: number): Promise<any> {
    return this.request({
      method: 'post',
      path: `/Invoice/PDF/${id}`,
    })
