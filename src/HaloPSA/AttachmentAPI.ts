...
export class AttachmentAPI extends HaloPSA {
   ...
   */
  postAttachment(attachment: Array<Attachment>): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Attachment',
      data: attachment,
   ...
   * @param {number} id
   */
  deleteAttachmentById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Attachment/${id}`,
    })
   ...
   * @param {string} token
   */
  getAttachmentNhserverById(id: number, token: string): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {string} id
   */
  getAttachmentImageById(id: string): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {string} id
   */
  deleteAttachmentImageById(id: string): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Attachment/image/${id}`,
    })
   ...
   * @param {string} nonce
   */
  getAttachmentImage(token: string, nonce: string): Promise<any> {
    return this.request({
      method: 'get',
   ...
   */
  postAttachmentGetS3PresignedURL(presignedURLRequest: Array<PresignedURLRequest>): Promise<any> {
    return this.request({
      method: 'post',
   ...
   * @param {number} id
   */
  getAttachmentDocumentById(id: number): Promise<any> {
    return this.request({
      method: 'get',
   ...
   * @param {number} id
   */
  deleteAttachmentDocumentById(id: number): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Attachment/document/${id}`,
    })
   ...
   */
  postAttachmentDocument(attachment: Array<Attachment>): Promise<any> {
    return this.request({
      method: 'post',
