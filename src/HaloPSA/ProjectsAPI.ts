 ...
 * @public
 */
export class ProjectsAPI extends HaloPSA {
   ...
   */
  postProjects({ faults }: { faults: Array<Faults> }): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Projects',
      data: faults,
   ...
   * @param {string} [reason] 
   */
  deleteProjectsById({ id, reason }: { id: number; reason?: string }): Promise<any> {
    return this.request({
      method: 'delete',
      path: `/Projects/${id}`,
      params: {
   ...
   */
  postProjectsView({ faults }: { faults: Array<Faults> }): Promise<any> {
    return this.request({
      method: 'post',
      path: '/Projects/View',
      data: faults,
